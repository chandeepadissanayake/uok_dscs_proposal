...
% IMPORTANT: Change the following lines to suit your research project
...
% Replace either "BibTeXFileName.bib" with the file name of the file containing the references or simply replace the file itself with the same name and leave this field as it is. You can, for instance, export BibTeX file from Zotero or Mendeley.
\newcommand{\bibTeXs}{BibTeXFileName.bib}
...
% IMPORTANT: Do not change formatting below this line.

% Bibliography Section
\bibliography{\bibTeXs}
